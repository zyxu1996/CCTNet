...
def rest_lite(pretrained=True, weight_path='./pretrained_weights/rest_lite.pth',  **kwargs):
...
class DependencyPath(nn.Module):
    def __init__(self, weight_path='./pretrained_weights/rest_lite.pth'):
...
class BANet(nn.Module):
    def __init__(self, nclass=6, weight_path='./pretrained_weights/rest_lite.pth'):
        ...
        self.conv_out = Output(256, 256, nclass, up_factor=8)
        self.init_weight()
...
if __name__ == '__main__':
    ...
    model_large = BANet(nclass=6, weight_path='../pretrained_weights/rest_lite.pth')
